...
class PopulateGroupContentService
{
    ...
    public function execute(
        ...
        foreach ($groupItem->symbols_group as $security) {
            ...
            $mappedSymbols = $this->mapSymbolsToModelAttributes($managerId, $symbolsForSecurity);
     ...
     */
    private function mapSymbolsToModelAttributes(string $managerId, array $symbols): array
    {
